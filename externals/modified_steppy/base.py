...
from .utils import display_upstream_structure, persist_as_png, get_logger, initialize_logger
...
class Step:
    ...
    def experiment_directory_output_step(self):
        ...
        os.makedirs(os.path.join(directory, self._mode), exist_ok=True)
        return os.path.join(directory, self._mode, self.name)
